...
function abrirEnlaces(){
  window.open('http://www.sergas.es/BUCEN/ListadoOfertasAsistenciais.aspx?IdPaxina=10158&idTipoTit=0&estado=1&nomeCent=Centro%20Castelao&codCatCent=0&numExp=0012/10','_newtab');
  setTimeout (function(){window.open('http://www.sergas.es/BUCEN/ListadoOfertasAsistenciais.aspx?IdPaxina=10158&idTipoTit=0&estado=1&nomeCent=Centro%20Castelao&codCatCent=0&numExp=0012/10','_newtab');}, 3000); 
...
function test(){
       var total = 0;
        $("#test input[type=radio]:checked").each(
                function(){ 
                        $this = $(this);
