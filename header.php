...
<html>
	<head>
		<title>Instituto Castelao para el tratamiento de adicciones</title>
		<!--meta-->
		<meta charset="UTF-8" />
			...
			<div class="header_container">
				<div class="header clearfix">
					<div class="header_left">
						<a href="?page=home" title="Instituto Castelao">
							<img class="img_logo" src="images/instituto_castelao_adicciones.png" alt="logo" />
							<!--
                                                        <span class="logo">INSTITUTO CASTELAO</span>
                                                        
                                                        <span class="slogan">Para el tratamiento de las adicciones</span>
                                                        -->
						</a>
					</div>
					<?php
